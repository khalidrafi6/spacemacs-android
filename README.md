...
3. **Launch Emacs**
   ...
   - Start Emacs and Spacemacs-Android should load automatically and start installing packages.

---

## 📱 Tips for Mobile Use

- For best results, use a Bluetooth keyboard or external input device.

...
3. **Launch Emacs**
   ...
   -  Next, it will start installing packages. This is called bootstrap. This process takes some time and requires a stable internet connection. If your internet is slow, you may consider increasing `dotspacemacs-elpa-timeout` in `~/.spacemacs`:
